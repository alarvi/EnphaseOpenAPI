 ...
 * @param `import` An array of import measurements, one for each day since the system started producing, or one for each day of the requested period. If the system has never produced energy, the array may be empty.
 * @param meta 
 */


data class GetSystemEnergyImportLifetimeResponse (
    ...
    @Json(name = "import")
    val `import`: kotlin.collections.List<kotlin.Int>? = null,
