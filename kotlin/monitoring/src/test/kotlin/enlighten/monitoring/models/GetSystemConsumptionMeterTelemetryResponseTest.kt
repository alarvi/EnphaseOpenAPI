...
class GetSystemConsumptionMeterTelemetryResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetSystemConsumptionMeterTelemetryResponse
        //val modelInstance = GetSystemConsumptionMeterTelemetryResponse()
        ...
        // to test the property `totalDevices` - Number of non-retired consumption meters in the site.
