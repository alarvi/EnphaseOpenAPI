...
class GetSystemProductionMicroTelemetryResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetSystemProductionMicroTelemetryResponse
        //val modelInstance = GetSystemProductionMicroTelemetryResponse()
        ...
        // to test the property `totalDevices` - Number of micro inverters in the site.
