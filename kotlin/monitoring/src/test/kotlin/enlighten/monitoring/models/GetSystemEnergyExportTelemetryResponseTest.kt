...
class GetSystemEnergyExportTelemetryResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetSystemEnergyExportTelemetryResponse
        ...
        // to test the property `granularity` - Granularity of the telemetry data. Default is 'day'.
        ...
        // to test the property `intervals` - An array of telemetry objects.
