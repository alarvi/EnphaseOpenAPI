...
class GetSystemEnergyImportTelemetryResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetSystemEnergyImportTelemetryResponse
        //val modelInstance = GetSystemEnergyImportTelemetryResponse()
        ...
        // to test the property `totalDevices` - Number of consumption meters in the site.
