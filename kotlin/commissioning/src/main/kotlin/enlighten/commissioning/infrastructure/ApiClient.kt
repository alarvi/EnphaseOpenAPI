package enlighten.commissioning.infrastructure
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "enlighten.commissioning.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val tempFile = java.nio.file.Files.createTempFile("tmp.enlighten.commissioning", null).toFile()
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        ...
        if (requestConfig.query["key"].isNullOrEmpty()) {
            if (apiKey["key"] != null) {
                if (apiKeyPrefix["key"] != null) {
                    requestConfig.query["key"] = listOf(apiKeyPrefix["key"]!! + " " + apiKey["key"]!!)
                } else {
                    requestConfig.query["key"] = listOf(apiKey["key"]!!)
                }
            }
        }
    }
