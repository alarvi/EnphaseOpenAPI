...
class DeleteActivationResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of DeleteActivationResponse
        //val modelInstance = DeleteActivationResponse()
