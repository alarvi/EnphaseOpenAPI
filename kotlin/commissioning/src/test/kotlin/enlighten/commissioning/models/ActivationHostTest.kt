...
class ActivationHostTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ActivationHost
        //val modelInstance = ActivationHost()
        ...
        // to test the property `active` - Whether the user is allowed to log in to Enlighten. Values true, false. Default true.
        should("test active") {
            // uncomment below to test the property
        ...
        // to test the property `enlightenEmails`
        should("test enlightenEmails") {
            // uncomment below to test the property
            //modelInstance.enlightenEmails shouldBe ("TODO")
        }

        // to test the property `enlightenView`
