...
class SetActivationMeterStatusResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SetActivationMeterStatusResponse
        //val modelInstance = SetActivationMeterStatusResponse()
